...
class TestButterWorthFilters(unittest.TestCase):
    def setUp(self):
        ...
        self.tolerance_resistance = (
            0.1  # Tolérance pour les comparaisons des resistances
        )
        self.tolerance_condensateur = (
            1e-6  # Tolérance pour les comparaisons des condensateurs
        )
    ...
    def test_first_order_lowpass_C(self):  # Test pour calcul des condensateurs
        ...
        condo_wanted = (
            1.061032953945969e-07  # Valeur attendue à la sortie de la fonction
        )

        # Appel de la méthode avec l'instance
        values = self.lowpass_instance.components(
            order=order, cutoff_frequency=self.cutoff_frequency, res_values=res_values
        )
        value_test = values["C"]
        ...
        self.assertAlmostEqual(
            value_test,
            condo_wanted,
            delta=self.tolerance_condensateur,
    ...
    def test_first_order_lowpass_R(self):  # Test pour calcul des resistances
        ...
        self.assertAlmostEqual(
            value_test,
            res_wanted,
            delta=self.tolerance_resistance,
    ...
    def test_second_order_lowpass(self):  # Test pour calcul des condensateurs
        ...
        condos_wanted = [
            3.751353959644919e-08,
            1.3504615231233503e-07,
        ]  # Valeur attendue à la sortie de la fonction
    ...
    def test_third_order_lowpass(self):  # Test pour calcul des condensateurs
        ...
        condos_wanted = [
            ...
            9.362055475993845e-09,
            4.5093900542703685e-08,
        ]  # Valeur attendue à la sortie de la fonction
    ...
    def test_fourth_order_lowpass(self):  # Test pour calcul des condensateurs
        ...
        condos_wanted = [
            4.901297828649154e-08,
            1.0336158624160052e-07,
            6.767137060219711e-09,
            5.1987962160967617e-08,
        ]  # Valeur attendue à la sortie de la fonction
    ...
    def test_first_order_highpass_C(self):  # Test pour calcul des condensateurs
        ...
        # Appel de la méthode avec l'instance
        values = self.highpass_instance.components(
            order=order, cutoff_frequency=self.cutoff_frequency, res_values=res_values
        )
        value_test = values["C"]
    ...
    def test_second_order_highpass(self):  # Test pour calcul des condensateurs
        ...
        res_values = [1000, 5000]  # Résistances spécifiées
        condos_wanted = [
            2.5366472992716085e-08,
            1.997147645859791e-07,
        ]  # Valeur attendue à la sortie de la fonction
    ...
    def test_third_order_highpass_invalid_resistances(
        self,
    ):  # Test pour une erreur au cas ou la condition n'est pas respecter
        order = 3
        res_values = [1000, 5000, 12000]  # Résistances spécifiées
    ...
    def test_fourth_order_highpass(self):  # Test pour calcul des condensateurs
        ...
        condos_wanted = [
            1.837507364548829e-08,
            2.75702796073461e-07,
            2.0923392245338568e-08,
            1.0088507483861624e-07,
        ]  # Valeur attendue à la sortie de la fonction
